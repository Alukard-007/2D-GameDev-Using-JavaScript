export const states = {
    //set of named constants that are assigned a number
    //readability of code++
    STANDING_LEFT : 0,
    STANDING_RIGHT: 1,
    SITTING_LEFT  : 2,
...
export class StandingLeft extends State {
    ...
    enter(){
        //setting standing left sprite col
        this.player.maxFrame = 6; //should be updated before frameY to avoid blinks; we can also set frameX to 0 in enter()
